...
//	CheckCirclesInQueue();
//	CheckBoxesInQueue();
//	CheckDynamicBoxCircleInQueue();
//
//	m_dynamicCircle2dQueue.clear();
//	m_dynamicBox2dQueue.clear();
//}
//
//void CollisionHandler::CheckCirclesInQueue()
//{
//	for (int i = 0; i < m_dynamicCircle2dQueue.size(); i++)
//	{
//		// Check against static.
//		// Check Circles against static Circles.
//		for (GameObject* staticCircle : m_staticCircle2d)
//			if (m_dynamicCircle2dQueue[i]->GetName() != staticCircle->GetName())
//				CheckCollisionBetweenCircles(m_dynamicCircle2dQueue[i], staticCircle, false);
//
//		// Check Circles against static Boxes.
//		for (GameObject* staticBox : m_staticBox2d)
//			CheckCollisionBetweenBoxCircle(staticBox, m_dynamicCircle2dQueue[i], false, true);
//
//		// Check Against Dynamic.
//		for (int j = 0; j < m_dynamicCircle2d.size(); j++)
//		{
//			if (m_dynamicCircle2dQueue[i]->GetName() == m_dynamicCircle2d[j]->GetName())
//				continue;
//
//			CheckCollisionBetweenCircles(m_dynamicCircle2dQueue[i], m_dynamicCircle2d[j]);
//		}
//
//		CircleCollider2D* cc = (CircleCollider2D*)m_dynamicCircle2dQueue[i]->GetComponent(ComponentType::CircleCollider2D);
//		cc->SetLastFramePosition(m_dynamicCircle2dQueue[i]->GetTransform()->position);
//	}
//}
//
//void CollisionHandler::CheckBoxesInQueue()
//{
//	for (int i = 0; i < m_dynamicBox2dQueue.size(); i++)
//	{
//		// Check against static.
//		// Check Boxes against static Circles.
//		for (GameObject* staticCircle : m_staticCircle2d)
//			CheckCollisionBetweenBoxCircle(m_dynamicBox2dQueue[i], staticCircle, false);
//
//		// Check Boxes against static Boxes.
//		for (GameObject* staticBox : m_staticBox2d)
//			if (m_dynamicBox2dQueue[i]->GetName() != staticBox->GetName())
//				CheckCollisionBetweenBoxes(m_dynamicBox2dQueue[i], staticBox, false);
//
//		for (int j = 0; j < m_dynamicBox2d.size(); j++)
//		{
//			if (m_dynamicBox2dQueue[i]->GetName() == m_dynamicBox2d[j]->GetName())
//				continue;
//
//			CheckCollisionBetweenBoxes(m_dynamicBox2dQueue[i], m_dynamicBox2d[j]);
//		}
//
//		BoxCollider2D* cc = (BoxCollider2D*)m_dynamicBox2dQueue[i]->GetComponent(ComponentType::BoxCollider2D);
//		cc->SetLastFramePosition(m_dynamicBox2dQueue[i]->GetTransform()->position);
//	}
//}
//
//void CollisionHandler::CheckDynamicBoxCircleInQueue()
//{
//	for (GameObject* box : m_dynamicBox2dQueue)
//		for (GameObject* circle : m_dynamicCircle2dQueue)
//			CheckCollisionBetweenBoxCircle(box, circle);
//}
//
//void CollisionHandler::CheckCollisionBetweenBoxes(GameObject* b1, GameObject* b2, bool pushBoth)
//{
...
//void CollisionHandler::RemoveFromBoxDynamic(GameObject* go)
//{
//	for (GameObject* dy : m_dynamicBox2d)
//	{
//		if (dy != go)
//			continue;
//
//		dy = m_dynamicBox2d.back();
//		m_dynamicBox2d.pop_back();
//	}
//}
//
//void CollisionHandler::RemoveFromBoxStatic(GameObject* go)
//{
//	for (GameObject* st : m_staticBox2d)
//	{
//		if (st != go)
//			continue;
//
//		st = m_staticBox2d.back();
//		m_staticBox2d.pop_back();
//	}
//}
//
//void CollisionHandler::RemoveFromCircleDynamic(GameObject* go)
//{
//	for (GameObject* dy : m_dynamicCircle2d)
//	{
//		if (dy != go)
//			continue;
//
//		dy = m_dynamicCircle2d.back();
//		m_dynamicCircle2d.pop_back();
//	}
//}
//
//void CollisionHandler::RemoveFromCircleStatic(GameObject* go)
//{
//	for (GameObject* st : m_staticCircle2d)
//	{
//		if (st != go)
//			continue;
//
//		st = m_staticCircle2d.back();
//		m_staticCircle2d.pop_back();
//	}
//}
//
